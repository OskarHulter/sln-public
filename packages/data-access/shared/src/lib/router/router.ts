...
import prisma from './domainClient.js'
...
export type ContextWithDB = trpc.inferAsyncReturnType<typeof createContextWithDB>
...
export default { app1Router, app2Router, app3Router, createContext, createContextWithDB }
